<template>
	<view class="register_page">
		...
		<view class="input_box" v-if="type == 1000">
			...
			<image v-if="isSee" src="../../static/images/ic_logon_display.png" mode="aspectFit" @click="isSee = false"></image>
			<image v-else-if="!isSee" src="../../static/images/ic_logon_hide.png" mode="aspectFit" @click="isSee = true"></image>
		</view>
		...
		<view class="third_party_login_box" v-if="isWeixin || (isIos && system >= 13)">
			...
			<view class="third_party_content">
				<image src="../../static/images/ic_login_weixin.png" v-if="isWeixin" @click="onWxAppLogin" mode="aspectFit"></image>
				<image src="../../static/images/ic_login_ios.png" v-if="isIos && system >= 13" @click="onAppleLogin" mode="aspectFit"></image>
			</view>
		</view>
		<!-- #endif -->
	</view>
	...
	.register_page {
		...
		.protocol_box {
			...
			.select {
				width: 36rpx;
				height: 36rpx;
				background-image: url("../../static/images/ic_gender_unselected.png");
				background-position: center center;
				background-repeat: no-repeat;
				background-size: 100% auto;
				margin-right: 15rpx;
				&.active {
					background-image: url("../../static/images/ic_agreed.png");
				}
			}
			>text {
				color: $themeColor;
